...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading text-center">Empleado</div>
      
        <div class="text-center mb-3"><a href="perfil.php"><img src="../img/logo_crem_adap.png" alt="logo cremeria liz"></a></div>    
