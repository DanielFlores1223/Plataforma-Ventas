...
<div class="row">
    ...
    <div class='col-5'>
        <table>
            <tr><td><label>ID</label></td><td><input name ='id' value='<?php echo $obj2->getIdEmpl(); ?>'></input></td></tr>
    ...
    <div class='col-5'>
        <table>
            ...
            <tr><td><label>Sueldo</label></td><td><input name ='sueldo' value='<?php echo $obj2->getSueldo() ?>'></input></td></tr>
            <tr><td><label>Tipo</label></td><td><input name ='tipo' value='<?php echo $obj2->getTipo() ?>'></input></td></tr>
            <tr><td><label>Estatus</label></td><td><input name ='estatus' value='<?php echo $obj2->getEstatus(); ?>'></input></td></tr>
        </table>
    </div>
</div>
</div >
