  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">  
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="servicios.php?pagina=1&p=admin" class="list-group-item list-group-item-action bg-light text-center">
          <div class="d-flex justify-content-center">
        ...
        <a href="empleados.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
          <div class="d-flex justify-content-center">
            ...
            <label for="" class="ml-2">Empleados</label>
          </div>
        </a>
        ...
        <a href="clientes.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
          <div class="d-flex justify-content-center">
            ...
            <label for="" class="ml-2">Clientes</label>
          </div>
        </a>
