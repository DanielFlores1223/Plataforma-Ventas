...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">  
        <div class="text-center mb-3 mt-4"><a href="perfil.php"><img src="../img/logo_crem_adap.png" alt="logo cremeria liz"></a></div>    
      <div class="list-group list-group-flush">
        ...
        <div class="align-self-center"><label for="">Inicio</label></div>
        </a>
        <a href="pedido.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
        ...
        <a href="inventario.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
          ...
          <div class="align-self-center"><label for="">Inventario</label></div>
        </a>
        <a href="empleados.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
          ...
          <div class="align-self-center"><label for="">Empleados</label></div>
        </a>
        <a href="clientes.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
          ...
          <div class="align-self-center"><label for="">Clientes</label></div>
        </a>
        <a href="proveedores.php?pagina=1" class="list-group-item list-group-item-action bg-light text-center">
          ...
          <div class="align-self-center"><label for="">Proveedores</label></div>     
        </a>
        <a href="reportes.php" class="list-group-item list-group-item-action bg-light text-center">
          ...
          <div class="align-self-center"><label for="">Reportes</label></div>
